...
<head>
 ...
 <link rel="icon" type="image/png" href="mbk_logo.png" />
  <title>MBK GlamHub | Booking Confirmation </title>
...
<!-- Multi-Step Progress Indicator (gradient + short dividers, Step 4 active) -->
<div class="w-full max-w-4xl mx-auto mt-8 mb-10 px-4 text-gray-600 font-semibold">
  <div class="flex items-center justify-center">
    ...
    <div class="flex flex-col items-center">
      ...
      <span class="mt-2 text-sm text-plum-700 font-bold">Booking Details</span>
    </div>
    ...
    <div class="flex flex-col items-center">
      ...
      <span class="mt-2 text-sm text-plum-700 font-bold">Team Selection</span>
    </div>
    ...
    <div class="flex flex-col items-center">
      ...
      <span class="mt-2 text-sm text-plum-700 font-bold">Package Selection</span>
    </div>
